...
public class MainActivity extends Activity implements
    ...
    private class DrawerListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                view = (RelativeLayout) getLayoutInflater().inflate(R.layout.shape_item, null);
    ...
    private void setWhatToDraw(int which) {
        ...
        final Drawing drawing = mDrawingFactory.createDrawing(Drawings.values()[which]);
        ...
        switch (id) {
            case R.id.btn_picker:
                ...
                if (popup.isShowing()) {
                    ...
                    popup.show(view, this);
                }
                break;
            case R.id.btn_decision:
                mDrawingPad.addDrawing(mDrawingFactory.createDrawing(Drawings.DECISION));
                break;
            case R.id.btn_process:
                mDrawingPad.addDrawing(mDrawingFactory.createDrawing(Drawings.RECT));
                break;
            case R.id.btn_terminator:
                mDrawingPad.addDrawing(mDrawingFactory.createDrawing(Drawings.TERMINATOR));
                break;
            default:
                break;
        }
