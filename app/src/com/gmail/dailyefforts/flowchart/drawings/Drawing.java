...
public abstract class Drawing {
	...
	protected int mDefaultWidth = Config.DEFAULT_WIDTH;
	protected int mDefaultHeight = Config.DEFAULT_HEIGHT;
	...
	protected Drawing() {
		...
		mTextPaint.setTextSize(Config.SHAPE_STROKE_WIDTH);
	...
	public boolean contains(final int x, final int y) {
		System.out.println("Drawing: " + x + "y: " + y + ", " + left + ", "
				+ right + ", " + top + ", " + bottom);
